...
merged.seurat <- readRDS(file.path(objects_dir,"master_seurat_post_harmony_iterative_batch_emulsion.rds"))
...
saveRDS(reductions.meta, file.path(results_dir,"master_seurat_low_res_clustering_table_harmony_iterative_batch_emulsion.rds"))


saveRDS(merged.seurat, file.path(objects_dir,"low_res_clustered_master_seurat_harmony_iterative_batch_emulsion.rds"))
